...
if __name__ == '__main__':
    ...
    parser.add_argument('--method', default='protonet', choices=['meta_deepbdc', 'protonet'])
    ...
    parser.add_argument('--tem', default='0.008', type=float)

    parser.add_argument('--num_classes', default=64, type=int, help='total number of classes in pretrain')
    parser.add_argument('--pretrain_path', default='/root/autodl-tmp/DeepBDC-main/checkpoints/mini_imagenet/ResNet12_protonet_pretrain/best_model.tar', help='pre-trained model .tar file path')
    ...
    parser.add_argument('--finetwo', default=False, type=bool)
    parser.add_argument('--fine_path', default='./checkpoints/cub/ResNet18_meta_deepbdc_pretrainCAO/400.tar', type=str)
    ...
    # model save path
    params.checkpoint_dir = './checkpoints/%s_FResNet/%s_%s' % (params.dataset, params.model, params.method)
    ...
    if params.finetwo==True:
        modelfile = os.path.join(params.fine_path)
