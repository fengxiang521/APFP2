...
if __name__ == '__main__':
    ...
    parser.add_argument('--finetwo', default=False, type=bool, help='微调步骤')
    parser.add_argument('--fine_path', default='./checkpoints/cub/ResNet18_meta_deepbdc_pretrainCAO/400.tar', type=str, help='微调模型路径')
